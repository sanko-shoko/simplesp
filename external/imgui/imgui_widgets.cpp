...
bool ImGui::DragScalar(const char* label, ImGuiDataType data_type, void* p_data, float v_speed, const void* p_min, const void* p_max, const char* format, float power)
{
    ...
    //if (strcmp("##light val", label) == 0) {
    //    printf("drag %d %d %d %d %d %d %d %d\n", id, temp_input_is_active, 
    //        temp_input_is_active, g.ActiveIdUsingNavDirMask,
    //        FocusableItemRegister(window, id), g.IO.KeyCtrl, 
    //        (hovered && g.IO.MouseDoubleClicked[0]), g.NavInputId);
    //}
...
bool ImGui::ColorButton(const char* desc_id, const ImVec4& col, ImGuiColorEditFlags flags, ImVec2 size)
{
    ...
    float rounding = g.Style.FrameRounding;// ImMin(g.Style.FrameRounding, grid_step * 0.5f);
    ImRect bb_inner = bb;
